...
public class SampleDataService : ISampleDataService
{
    ...
    private List<SampleOrderDetail> _allItems;
    private List<SampleCustomer> _allCustomer;
    private List<OfficeList> _allOffice;
    ...
    private static IList<SampleOrderDetail> AllItems()
    {
        // The following is order summary data
        var companies = AllCompanies();
        return (companies.SelectMany(c => c.Orders).ToList()).SelectMany(c => c.Details).ToList();
    }
    private static IList<SampleCustomer> AllCustomer()
    {
        var companies = AllCompanies().Select(s => new SampleCustomer
        {
            Id = s.CompanyID,
    ...
    private static IList<OfficeList> AllOffices()
    {
        return AllOffice().ToList();
    }
    ...
    private static IEnumerable<OfficeList> AllOffice()
    {
        return new List<OfficeList>()
        {
            new OfficeList()
            {
            Id = 1,
            Name = "Dhanmondi Daily Super Shop",
            Address = "Dhanmondi",
            ...
            {
            Id = 3,
            Name = "Agargaon Daily Super Shop",
            Address = "Agargaon",
            CounterList=new List<Counter>()
            },
            new OfficeList()
            ...
            {
            Id = 4,
            Name = "Lalmatia Daily Super Shop",
            Address = "Lalmatia",
            CounterList=new List<Counter>()
            }
        };
    ...
    public async Task<IList<SampleOrderDetail>> GetGridItemAsync()
    {
        _allItems ??= new List<SampleOrderDetail>(AllItems());

        await Task.CompletedTask;
        return _allItems;
    }

    public async Task<IList<SampleCustomer>> GetSampleCustomerAsync()
    {
        _allCustomer ??= new List<SampleCustomer>(AllCustomer());

        await Task.CompletedTask;
        return _allCustomer;
    }
    public async Task<IList<OfficeList>> GetOfficeListAsync()
    {
        _allOffice ??= new List<OfficeList>(AllOffices());
